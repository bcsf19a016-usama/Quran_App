...
public class Store {
    ...
    public ArrayList<Parah> getAllPararh()
    {
        ArrayList<Parah> prahs = new ArrayList<>();
        for (int i =0;i<PSP.length;i++)
        {
            prahs.add(new Parah(Integer.toString(i+1),englishParahName[i],ParahName[i],
                    Integer.toString(PSP[i])));
        }
        return prahs;
    }
    public String getSurahName(int i){return urduSurahNames[i];}
